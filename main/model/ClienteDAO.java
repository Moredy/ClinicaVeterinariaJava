...
public class ClienteDAO extends DAO {
    ...
    public Cliente create(String nome, String end, String cep, String email, String telefone) {
        try {
            ...
            stmt = getConnection().prepareStatement("INSERT INTO cliente (nome, end, cep, email, telefone) VALUES (?,?,?,?,?)");
    ...
    public void update(Cliente cliente) {
        try {
            PreparedStatement stmt;
            stmt = getConnection().prepareStatement("UPDATE cliente SET nome=?, end=?, cep=?, email=?, telefone=? WHERE id=?");
    ...
    public void delete(Cliente cliente) {
        PreparedStatement stmt;
        try {
            stmt = getConnection().prepareStatement("DELETE FROM cliente WHERE id = ?");
