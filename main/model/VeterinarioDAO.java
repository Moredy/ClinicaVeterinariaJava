...
public class VeterinarioDAO extends DAO {
    ...
    public Veterinario create(String nome, String email, String telefone) {
        try {
            ...
            stmt = getConnection().prepareStatement("INSERT INTO vet (nome, email, telefone) VALUES (?,?,?)");
    ...
    public void update(Veterinario veterinario) {
        try {
            PreparedStatement stmt;
            stmt = getConnection().prepareStatement("UPDATE vet SET nome=?, email=?, telefone=? WHERE id=?");
    ...
    public void delete(Veterinario veterinario) {
        PreparedStatement stmt;
        try {
            stmt = getConnection().prepareStatement("DELETE FROM vet WHERE id = ?");
