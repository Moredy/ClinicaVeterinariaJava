...
public class ExameDAO extends DAO {
    ...
    public Exame create(String nome, int id_consulta) {
        try {
            ...
            stmt = getConnection().prepareStatement("INSERT INTO exame (nome, id_consulta) VALUES (?,?)");
    ...
    public List retrieveExamesByIdConsulta(Integer idConsulta) {
        return this.retrieve("SELECT * FROM exame WHERE id_consulta = " + idConsulta);
    }
    ...
    public void update(Exame exame) {
        try {
            PreparedStatement stmt;
            stmt = getConnection().prepareStatement("UPDATE exame SET nome=?, id_consulta=? WHERE id=?");
